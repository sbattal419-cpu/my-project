      ...
      <div className="legal-container">
        ...
        <div className="legal-body">
          <section className="legal-section">
            ...
            <p>باستخدامك لمنصة إدارة الحقوق الملكية والفكرية، فإنك توافق على الالتزام بهذه الشروط والأحكام. إن كنت لا توافق على أي من هذه الشروط، يرجى التوقف عن استخدام المنصة.</p>
          </section>
